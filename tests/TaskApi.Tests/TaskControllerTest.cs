...
public class TaskControllerTests{
    ...
    //     _ctrl.GetAll().Should().BeOfType<OkObjectResult>().Which.Value.Should().BeAssignableTo<IEnumerable<TaskItem>>().Which.Should().HaveCount(2);
    // }
    ...
    //     _ctrl.GetById(1).Should().BeOfType<OkObjectResult>().Which.Value.Should().BeOfType<TaskItem>().Which.Title.Should().Be("Tarea");
    // }
